...
public class CreatedScheludeManage {
    @SerializedName("thu2")
    @Expose
    private String thu2;
    @SerializedName("thu3")
    ...
    public CreatedScheludeManage(String thu2, String thu3, String thu4, String thu5, String thu6, String thu7) {
        this.thu2 = thu2;
        this.thu3 = thu3;
        this.thu4 = thu4;
        this.thu5 = thu5;
