...
import com.example.niit.entities.CreatedSchelude;
...
//        getData();
    ...
    public void onClickCreateSchelude() {
        ...
        if (classes.isEmpty()) {
            ...
            CreatedSchelude createdSchelude = new CreatedSchelude(thu2, thu3, thu4, thu5, thu6, thu7);

            databaseReference.child("scheludes").child(Classes).setValue(createdSchelude, new DatabaseReference.CompletionListener() {
                @Override
